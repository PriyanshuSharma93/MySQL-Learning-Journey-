...
# MySQL Learning Journey — Day 8

## 📌 Overview

Briefly explain what I learned today about the SQL WHERE clause and how it is used to filter records and retrieve specific data from database tables.

Mention that today I explored different filtering techniques including NULL handling, pattern matching with LIKE, range filtering with BETWEEN, logical operators, and subqueries.
...
# Screenshots
<img width="1920" height="1080" alt="Screenshot 2026-08-10 182635" src="https://github.com/user-attachments/assets/ea2474b2-5257-4556-b285-236cf90770a8" />

## 🔍 WHERE Clause

Explain the purpose of the WHERE clause and provide its basic syntax:
